...
export const routes: Routes = [
  ...
  {path:'favorites',component:FaviroteCom,title:'My Favorites', canActivate:[authGuardGuard]},
  ...
  { path: 'addproperty', component: AddProperty, title: 'Add Property', canActivate: [authGuardGuard, roleGuardGuard], data: { roles: ['Owner'] } },
  { path: 'ownerDashboard', component: OwnerDashboardComponent, title: 'Owner Dashboard', canActivate: [authGuardGuard, roleGuardGuard], data: { roles: ['Owner'] } },
  { path: 'profile', component: ProfileComponent, title: 'User Profile', canActivate: [authGuardGuard] },
  { path: 'userProfile', component: ProfileComponent, title: 'User Profile', canActivate: [authGuardGuard] },
  { path: 'edit-profile', component: EditProfile, title: 'Edit Profile', canActivate: [authGuardGuard] },
  { path: 'editProfile', component: EditProfile, title: 'Edit Profile', canActivate: [authGuardGuard] },
  { path: 'forget-password', component: ForgetPassword },
  { path: 'reset-password', component: ResetPassword },
  { path: 'contact-us', component: ContactUs },
  { path: 'contact', component: ContactUs },
  { path: 'about', component: AboutUs },
  { path: 'editproperty', component: EditPropertyComponent, title: 'Edit Property', canActivate: [authGuardGuard, roleGuardGuard], data: { roles: ['Owner'] } },
